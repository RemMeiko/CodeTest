...
/*
    public static void main(String[] args) throws IOException {
        File file = new File("E:\\资料\\大二(下)\\实训\\单片机\\18物联1-2班花名册.xlsx");
        InputStream input = new FileInputStream(file);
        XSSFWorkbook read = new XSSFWorkbook(input);

        XSSFSheet readsheet = read.getSheetAt(0);
        System.out.println(readsheet.getRow(2));
    }
}*/
...
/*        System.out.println(xssfSheet.getLastRowNum());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //测试读取数据
        List<Map<String,String>> list2 = readExcel(input,"");
        for (Map<String, String> a : list2) {
        ...
        File file1 = new File("E:\\资料\\大二(下)\\实训\\单片机\\1.xlsx");
        OutputStream outputStream = new FileOutputStream(file1);
        List<List> Teo = new ArrayList<List>();
        Teo.add(One);

        writeExcel(Teo,outputStream);
    }
}
